...
if __name__ == "__main__":
    ...
    model = SNGPRegressor(input_dim=44)
    ...
    model.load_state_dict(torch.load('./MLP-80-0.80-2.pth', map_location='cuda:0'))
    ...
    performance_df.to_csv("../result/MLP-cp_performance_metrics_detailed.csv", index=False)
